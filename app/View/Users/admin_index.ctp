	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Liste de tous les utilisateurs'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('Numéro de Téléphone'); ?></th>
				...
				<?php foreach ($users as $user): ?>
					<tr>
						...
						<td class="actions">
							...
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'profile', $user['User']['id'], 'admin' => false), array('escape' => false)); ?>
