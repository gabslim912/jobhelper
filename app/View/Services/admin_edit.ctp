	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Modification du service'); ?></h1>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('Service', array('role' => 'form')); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('sub_category_id', array('class' => 'form-control', 'placeholder' => 'Sub Category Id','label' => 'Sous-categorie correspondante'));?>
				</div>
				...
				<div class="form-group">
					<?php echo $this->Form->input('completed', array( 'type' => 'checkbox','label' => 'Cochez pour rendre le service disponible'));?>
				</div>
				<div class="form-group">
