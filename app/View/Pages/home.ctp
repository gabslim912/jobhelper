...
<div class="fullpage-site">
	...
	<!-- section start -->
	<!-- ================ -->
	<section id="section-1" class="section dark-translucent-bg" style="background-image: url(img/agency-background-img-1.jpg);">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
	...
	<!-- section start -->
	<!-- ================ -->
	<section id="section-2" class="section dark-translucent-bg" style="background-image: url(img/agency-background-img-2.jpg);">
		<div class="container">
			<div class="row">
	...
	<section id="section-4" class="section dark-translucent-bg" style="background-image: url(img/agency-background-img-3.jpg);">
